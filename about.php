    ...
    <!-- Navigation -->
        ...
        <div class="row" style="margin-bottom:50px;margin-left:50px">
               ...
               <P>faculty feedback system, which is generally used in the college to rate the faculty based on the performance...Here we have 2 modules such as administrator, student.
